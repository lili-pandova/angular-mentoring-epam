...
@NgModule({
  declarations: [AppComponent, IndexComponent, HeaderComponent, LogoComponent, UserLogComponent,
  BreadcrumbsComponent, SearchComponent, AddCoursesComponent, ItemComponent, LoadMoreComponent,
